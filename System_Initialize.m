...
elseif channel_bandwidth == 20e6
    subcarrier_spacing = 15e3; %% Initializing the subcarrier spacing in Hz
    symbol_duration = 1/subcarrier_spacing; %% Initializing symbol duration
    cyclic_prefix_duration = symbol_duration * 0.0703125; %% Initializing cyclic prefix duration
    number_of_symbol_per_subcarrier = floor((1 * 1000e-6) / (symbol_duration + cyclic_prefix_duration)); %% Initializing the number of symbols per subcarrier
    guard_bandwidth = 4.160e6; %% Initializing the guard bandwidth [20% of channel bandwidth]
    guard_interval = 1/guard_bandwidth; %% Initializing guard interval
    number_of_resource_block = (channel_bandwidth - guard_bandwidth) / (number_of_data_subcarrier * subcarrier_spacing); %% Initializing the number of resource block 
    sampling_frequency = subcarrier_spacing * number_of_total_subcarrier * number_of_resource_block; %% Initializing sampling frequency
    fft_length = 2048; %% Initializing FFT length
    cyclic_prefix_length = 144; %% Initializing cyclic prefix length [7.03125% of fft length]
    guard_band = [floor(fft_length * 0.10); floor(fft_length * 0.10)]; %% Initializing guard band
elseif channel_bandwidth == 50e6
    subcarrier_spacing = 30e3; %% Initializing the subcarrier spacing in Hz
    symbol_duration = 1/subcarrier_spacing; %% Initializing symbol duration
    cyclic_prefix_duration = symbol_duration * 0.0703125; %% Initializing cyclic prefix duration
    number_of_symbol_per_subcarrier = floor((1 * 1000e-6) / (symbol_duration + cyclic_prefix_duration)); %% Initializing the number of symbols per subcarrier
    guard_bandwidth = 11.120e6; %% Initializing the guard bandwidth [20% of channel bandwidth]
    guard_interval = 1/guard_bandwidth; %% Initializing guard interval
    number_of_resource_block = (channel_bandwidth - guard_bandwidth) / (number_of_data_subcarrier * subcarrier_spacing); %% Initializing the number of resource block 
    sampling_frequency = subcarrier_spacing * number_of_total_subcarrier * number_of_resource_block; %% Initializing sampling frequency
    fft_length = 2048; %% Initializing FFT length
    cyclic_prefix_length = 144; %% Initializing cyclic prefix length [7.03125% of fft length]
    guard_band = [floor(fft_length * 0.10); floor(fft_length * 0.10)]; %% Initializing guard band
elseif channel_bandwidth == 80e6
    subcarrier_spacing = 60e3; %% Initializing the subcarrier spacing in Hz
    symbol_duration = 1/subcarrier_spacing; %% Initializing symbol duration
    cyclic_prefix_duration = symbol_duration * 0.0703125; %% Initializing cyclic prefix duration
    number_of_symbol_per_subcarrier = floor((1 * 1000e-6) / (symbol_duration + cyclic_prefix_duration)); %% Initializing the number of symbols per subcarrier
    guard_bandwidth = 16.640e6; %% Initializing the guard bandwidth [20% of channel bandwidth]
    guard_interval = 1/guard_bandwidth; %% Initializing guard interval
    number_of_resource_block = (channel_bandwidth - guard_bandwidth) / (number_of_data_subcarrier * subcarrier_spacing); %% Initializing the number of resource block 
    sampling_frequency = subcarrier_spacing * number_of_total_subcarrier * number_of_resource_block; %% Initializing sampling frequency
    fft_length = 2048; %% Initializing FFT length
...
if coding_rate == 1/3
    convo_encoder = comm.ConvolutionalEncoder('TrellisStructure', poly2trellis(7, [133 171 165]), 'TerminationMethod', 'Truncated');
    viterbi_decoder = comm.ViterbiDecoder( 'InputFormat','Hard', 'TrellisStructure', poly2trellis(7, [133 171 165]), ...
                                    'TerminationMethod', 'Truncated', 'OutputDataType', 'double');
elseif coding_rate == 1/2
    convo_encoder = comm.ConvolutionalEncoder('TrellisStructure', poly2trellis(7,[171 133]), 'TerminationMethod', 'Truncated');
    viterbi_decoder = comm.ViterbiDecoder( 'InputFormat','Hard', 'TrellisStructure', poly2trellis(7,[171 133]), ...
                                    'TerminationMethod', 'Truncated', 'OutputDataType', 'double');
end
%%% Initializing encoder and decoder based on coding rate
